...
ReceiveNode::ReceiveNode() : Node("talker"), is_serial_open_(false)
{
    ...
    this->declare_parameter("zone_config_path", "");
    ...
    // 初始化区域模式切换器
    zone_switcher_ = std::make_shared<cod_serial::ZoneModeSwitcher>(
        this,
        cod_serial::RectZone{2.6, 5.9, -5.65, 2.3},
        zone_config_path);
    mode_params_ = cod_serial::ModeDecisionParams();
...
void ReceiveNode::execute_mode_navigation(const cod_serial::DecisionResult &decision)
{
    ...
    if (decision.has_nav_goal)
    {
        ...
        {
        case cod_serial::ZoneMode::DEFENSE:
            mission = "defense";
            break;
        case cod_serial::ZoneMode::ATTACK:
            mission = "attack";
            break;
        case cod_serial::ZoneMode::MOVE:
            mission = "patrol";
            break;
        case cod_serial::ZoneMode::SENSITIVE:
        default:
            mission = "none";
            break;
        }
